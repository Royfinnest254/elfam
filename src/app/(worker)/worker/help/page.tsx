...
export default function WorkerHelpPage() {
  ...
  return (
    <div className="space-y-6 text-[#202124] pb-12">
      <header className="border-b border-[#DADCE0] pb-4">
        ...
        <p className="body-small text-[#5F6368] mt-0.5 uppercase tracking-wider font-semibold">Operational procedures and manager contact information</p>
      </header>

      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Contact Manager Card */}
        <div className="lg:col-span-6 system-card p-6 space-y-6 rounded-none">
          <h3 className="text-lg font-normal text-[#1A56DB] border-b border-[#DADCE0] pb-4">Contact General Manager</h3>
          {manager ? (
            <div className="space-y-4">
              <div>
                <strong className="text-base font-bold text-[#1A56DB] block tracking-tight">{manager.name}</strong>
                <span className="status-badge text-[9px] uppercase px-1.5 py-0.5 mt-2 bg-teal/5 border-teal/20 text-teal">
                  {manager.role}
                </span>
              </div>

              <div className="space-y-3 pt-4 border-t border-[#DADCE0] font-mono text-xs font-semibold text-[#5F6368]">
            ...
            <p className="body-small text-[#5F6368] italic">Manager details loading...</p>
          )}
        </div>

        {/* Safety Guidelines */}
        <div className="lg:col-span-6 system-card p-6 space-y-6 rounded-none">
          <h3 className="text-lg font-normal text-[#1A56DB] border-b border-[#DADCE0] pb-4">Safety & Quality Rules</h3>
          <div className="space-y-4 text-xs font-medium text-[#5F6368] leading-relaxed">
