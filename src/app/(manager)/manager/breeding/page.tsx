  ...
  return (
    <div className="space-y-8 font-sans text-[#202124] pb-12">
      <header className="border-b border-[#DADCE0] pb-6">
        ...
        <p className="text-xs text-[#5F6368] font-semibold mt-1 uppercase tracking-wider">Artificial Insemination (AI) services and pregnancy check logs</p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-6 system-card p-6 space-y-6">
          ...
          <form onSubmit={handleLogService} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-[10px] font-black text-[#5F6368] mb-1.5 uppercase tracking-wider">Service Type</label>
                <select
                  value={serviceType}
            ...
            <div>
              <label className="block text-[10px] font-black text-[#5F6368] mb-1.5 uppercase tracking-wider">Service Notes</label>
              <input
                type="text"
        ...
        <div className="lg:col-span-6 system-card p-6 space-y-6">
          ...
          <form onSubmit={handleLogPregnancy} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-[10px] font-black text-[#5F6368] mb-1.5 uppercase tracking-wider">Checkup Result</label>
                <select
                  value={pregResult}
              ...
              <div>
                <label className="block text-[10px] font-black text-[#5F6368] mb-1.5 uppercase tracking-wider">Checked By (Staff)</label>
                <select
