...
export default function ManagerContractsPage() {
  ...
  if (contracts === undefined) {
    return <div className="text-xs text-[#5F6368] uppercase font-black tracking-widest p-8 font-sans">Loading contract files...</div>;
  }
  ...
  return (
    <div className="space-y-8 font-sans text-[#202124] pb-12">
      <header className="border-b border-[#DADCE0] pb-6">
        ...
        <p className="text-xs text-[#5F6368] font-semibold mt-1 uppercase tracking-wider">Cereal buyer agreements, quotas, pricing, and dispatch targets</p>
      </header>
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <h3 className="text-base font-black uppercase text-[#202124] mt-2 group-hover:underline">
                    {contract.buyer}
                  </h3>
                </div>
              ...
              <div className="border-t border-[#DADCE0] pt-4 space-y-2 text-xs font-semibold text-[#5F6368]">
                <div className="flex justify-between">
                  ...
                  <span className="text-[#202124] font-bold">{contract.season}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[10px] font-black text-[#7A869A] uppercase tracking-wider">Crop Contracted</span>
                  <span className="text-[#202124] font-bold uppercase">{contract.crop}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[10px] font-black text-[#7A869A] uppercase tracking-wider">Contracted Weight</span>
                  <span className="text-[#202124] font-bold">{contract.contractedBags} Bags</span>
                </div>
                <div className="flex justify-between">
