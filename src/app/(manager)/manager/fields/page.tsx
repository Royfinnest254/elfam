...
export default function ManagerFieldsPage() {
  ...
  if (fields === undefined) {
    return <div className="text-xs text-[#5F6368] uppercase font-black tracking-widest p-8 font-sans">Loading fields registry...</div>;
  }
  ...
  return (
    <div className="space-y-8 font-sans text-[#202124] pb-12">
      <header className="border-b border-[#DADCE0] pb-6">
        ...
        <p className="text-xs text-[#5F6368] font-semibold mt-1 uppercase tracking-wider">Managed acreage blocks, crop allocations, and treatments</p>
      </header>
          ...
          >
            ...
            <div className="border-t border-[#DADCE0] pt-4 space-y-2 text-xs font-semibold text-[#5F6368]">
              <div className="flex justify-between">
                ...
                <span className="text-[#202124] font-bold">{field.acres} Acres</span>
              </div>
              <div className="flex justify-between">
